...
namespace ASP.NET_Core.Models.Mock
{
    public class MockPieRepository : IPieRepository
    {
        ...
        public IEnumerable<Pie> PiesOfTheWeek
        {
            get
            {
                return GetPies.Where(item => item.IsPieOfTheWeek);
            }
        }

        public Pie? GetPieById(int id)
            => GetPies
            .FirstOrDefault(item => item.PieId == id,
                            new Pie { Name = "Not found" });
    }
}
